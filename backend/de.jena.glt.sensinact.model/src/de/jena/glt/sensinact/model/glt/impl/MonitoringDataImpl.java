 ...
 * @generated
 */
public class MonitoringDataImpl extends ServiceImpl implements MonitoringData {
	/**
	...
	protected EClass eStaticClass() {
		return GltPackage.Literals.MONITORING_DATA;
	}
	...
	public void setValue(float newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GltPackage.MONITORING_DATA__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GltPackage.MONITORING_DATA__VALUE:
				return getValue();
		}
