 ...
 * @generated
 */
public class IcesensorSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case IcesensorPackage.ICE_SENSOR: {
				IceSENSOR iceSENSOR = (IceSENSOR)theEObject;
				T result = caseIceSENSOR(iceSENSOR);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IcesensorPackage.DATA: {
				Data data = (Data)theEObject;
				T result = caseData(data);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IcesensorPackage.COORDS: {
				Coords coords = (Coords)theEObject;
				T result = caseCoords(coords);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IcesensorPackage.SENSOR_DATA: {
				SensorData sensorData = (SensorData)theEObject;
				T result = caseSensorData(sensorData);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IcesensorPackage.SENSOR_MESSAGE: {
				SensorMessage sensorMessage = (SensorMessage)theEObject;
				T result = caseSensorMessage(sensorMessage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Sensor Message</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Sensor Message</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSensorMessage(SensorMessage object) {
		return null;
	}
