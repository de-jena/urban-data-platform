...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,de.jena.model.icesensor\"" })
...
public class IcesensorConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(IcesensorPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(IcesensorPackage.eNS_URI, ePackage);
		}
