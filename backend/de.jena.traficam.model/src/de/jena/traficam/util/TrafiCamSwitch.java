...
public class TrafiCamSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TrafiCamPackage.TRAFI_CAM: {
				TrafiCam trafiCam = (TrafiCam)theEObject;
				T result = caseTrafiCam(trafiCam);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TrafiCamPackage.TRAFI_CAM_OBJECT: {
				TrafiCamObject trafiCamObject = (TrafiCamObject)theEObject;
				T result = caseTrafiCamObject(trafiCamObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TrafiCamPackage.GPS_COORDINATES: {
				GpsCoordinates gpsCoordinates = (GpsCoordinates)theEObject;
				T result = caseGpsCoordinates(gpsCoordinates);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TrafiCamPackage.COORDINATES: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Trafi Cam</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Trafi Cam</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTrafiCam(TrafiCam object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseTrafiCamObject(TrafiCamObject object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Gps Coordinates</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Gps Coordinates</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGpsCoordinates(GpsCoordinates object) {
		return null;
	}
