 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.chirpstack.moisture.model.moisture.impl.RainImpl#getRainGauge <em>Rain Gauge</em>}</li>
 *   <li>{@link de.jena.chirpstack.moisture.model.moisture.impl.RainImpl#getRainAccumulation <em>Rain Accumulation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RainImpl extends ServiceImpl implements Rain {
	...
	protected EClass eStaticClass() {
		return ChirpstackMoisturePackage.Literals.RAIN;
	}
	...
	public void setRainGauge(double newRainGauge) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackMoisturePackage.RAIN__RAIN_GAUGE, oldRainGauge, rainGauge));
	}
	...
	public void setRainAccumulation(double newRainAccumulation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackMoisturePackage.RAIN__RAIN_ACCUMULATION, oldRainAccumulation, rainAccumulation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ChirpstackMoisturePackage.RAIN__RAIN_GAUGE:
				return getRainGauge();
			case ChirpstackMoisturePackage.RAIN__RAIN_ACCUMULATION:
