 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.chirpstack.moisture.model.moisture.impl.Teros21Impl#getPotentialWater1 <em>Potential Water1</em>}</li>
 *   <li>{@link de.jena.chirpstack.moisture.model.moisture.impl.Teros21Impl#getPotentialWater2 <em>Potential Water2</em>}</li>
 *   <li>{@link de.jena.chirpstack.moisture.model.moisture.impl.Teros21Impl#getTemperatur1 <em>Temperatur1</em>}</li>
 *   <li>{@link de.jena.chirpstack.moisture.model.moisture.impl.Teros21Impl#getTemperatur2 <em>Temperatur2</em>}</li>
 *   <li>{@link de.jena.chirpstack.moisture.model.moisture.impl.Teros21Impl#getBattery <em>Battery</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Teros21Impl extends ServiceImpl implements Teros21 {
	...
	protected EClass eStaticClass() {
		return ChirpstackMoisturePackage.Literals.TEROS21;
	}
	...
	public void setPotentialWater1(double newPotentialWater1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackMoisturePackage.TEROS21__POTENTIAL_WATER1, oldPotentialWater1, potentialWater1));
	}
	...
	public void setPotentialWater2(double newPotentialWater2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackMoisturePackage.TEROS21__POTENTIAL_WATER2, oldPotentialWater2, potentialWater2));
	}
	...
	public void setTemperatur1(double newTemperatur1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackMoisturePackage.TEROS21__TEMPERATUR1, oldTemperatur1, temperatur1));
	}
	...
	public void setTemperatur2(double newTemperatur2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackMoisturePackage.TEROS21__TEMPERATUR2, oldTemperatur2, temperatur2));
	}
	...
	public void setBattery(double newBattery) {
		...
		battery = newBattery;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackMoisturePackage.TEROS21__BATTERY, oldBattery, battery));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ChirpstackMoisturePackage.TEROS21__POTENTIAL_WATER1:
				return getPotentialWater1();
			case ChirpstackMoisturePackage.TEROS21__POTENTIAL_WATER2:
				return getPotentialWater2();
			case ChirpstackMoisturePackage.TEROS21__TEMPERATUR1:
				return getTemperatur1();
			case ChirpstackMoisturePackage.TEROS21__TEMPERATUR2:
				return getTemperatur2();
			case ChirpstackMoisturePackage.TEROS21__BATTERY:
				return getBattery();
		}
