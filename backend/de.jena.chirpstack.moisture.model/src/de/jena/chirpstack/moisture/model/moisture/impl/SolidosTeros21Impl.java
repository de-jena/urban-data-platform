 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.chirpstack.moisture.model.moisture.impl.SolidosTeros21Impl#getSensor <em>Sensor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SolidosTeros21Impl extends ProviderImpl implements SolidosTeros21 {
	...
	protected EClass eStaticClass() {
		return ChirpstackMoisturePackage.Literals.SOLIDOS_TEROS21;
	}
	...
	public NotificationChain basicSetSensor(Teros21 newSensor, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ChirpstackMoisturePackage.SOLIDOS_TEROS21__SENSOR, oldSensor, newSensor);
	...
	public void setSensor(Teros21 newSensor) {
		if (newSensor != sensor) {
			...
			if (sensor != null)
				msgs = ((InternalEObject)sensor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ChirpstackMoisturePackage.SOLIDOS_TEROS21__SENSOR, null, msgs);
			if (newSensor != null)
				msgs = ((InternalEObject)newSensor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ChirpstackMoisturePackage.SOLIDOS_TEROS21__SENSOR, null, msgs);
			msgs = basicSetSensor(newSensor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackMoisturePackage.SOLIDOS_TEROS21__SENSOR, newSensor, newSensor));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ChirpstackMoisturePackage.SOLIDOS_TEROS21__SENSOR:
