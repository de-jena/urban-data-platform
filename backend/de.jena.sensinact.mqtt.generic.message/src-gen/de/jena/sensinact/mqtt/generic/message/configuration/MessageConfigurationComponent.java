...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,de.jena.sensinact.mqtt.generic.message\"" })
...
public class MessageConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(MessagePackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(MessagePackage.eNS_URI, ePackage);
		}
