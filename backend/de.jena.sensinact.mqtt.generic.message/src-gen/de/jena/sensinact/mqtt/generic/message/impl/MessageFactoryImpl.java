...
public class MessageFactoryImpl extends EFactoryImpl implements MessageFactory {
	...
	public Point createEPoint(final String it) {
		try { return new tools.jackson.databind.ObjectMapper().readValue(it, org.eclipse.sensinact.gateway.geojson.Point.class); } catch (tools.jackson.core.JacksonException e) { throw new IllegalArgumentException(e); }
	}
	...
	public FeatureCollection createEFeatureCollection(final String it) {
		try { return new tools.jackson.databind.ObjectMapper().readValue(it, org.eclipse.sensinact.gateway.geojson.FeatureCollection.class); } catch (tools.jackson.core.JacksonException e) { throw new IllegalArgumentException(e); }
	}
	...
	public Polygon createEPolygon(final String it) {
		try { return new tools.jackson.databind.ObjectMapper().readValue(it, org.eclipse.sensinact.gateway.geojson.Polygon.class); } catch (tools.jackson.core.JacksonException e) { throw new IllegalArgumentException(e); }
	}
