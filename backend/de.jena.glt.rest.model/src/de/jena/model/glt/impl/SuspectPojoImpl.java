 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.model.glt.impl.SuspectPojoImpl#getSiteId <em>Site Id</em>}</li>
...
public class SuspectPojoImpl extends MinimalEObjectImpl.Container implements SuspectPojo {
	...
	public void setSiteId(String newSiteId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GltPackage.SUSPECT_POJO__SITE_ID, oldSiteId, siteId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GltPackage.SUSPECT_POJO__SITE_ID:
				return getSiteId();
