 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.bike.impl.ResponseImpl#getCode <em>Code</em>}</li>
 *   <li>{@link de.jena.bike.impl.ResponseImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link de.jena.bike.impl.ResponseImpl#getResponse <em>Response</em>}</li>
 *   <li>{@link de.jena.bike.impl.ResponseImpl#getResult <em>Result</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResponseImpl extends MinimalEObjectImpl.Container implements Response {
	...
	protected EClass eStaticClass() {
		return BikePackage.Literals.RESPONSE;
	}
	...
	public void setCode(int newCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BikePackage.RESPONSE__CODE, oldCode, code));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BikePackage.RESPONSE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setResponse(jakarta.ws.rs.core.Response newResponse) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BikePackage.RESPONSE__RESPONSE, oldResponse, response));
	}
	...
	public EList<EObject> getResult() {
		if (result == null) {
			result = new EObjectContainmentEList<EObject>(EObject.class, this, BikePackage.RESPONSE__RESULT);
		}
		return result;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BikePackage.RESPONSE__RESULT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BikePackage.RESPONSE__CODE:
				return getCode();
			case BikePackage.RESPONSE__DESCRIPTION:
				return getDescription();
			case BikePackage.RESPONSE__RESPONSE:
				return getResponse();
			case BikePackage.RESPONSE__RESULT:
				return getResult();
		}
