 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.bike.impl.LineStringImpl#getCoordinates <em>Coordinates</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LineStringImpl extends MinimalEObjectImpl.Container implements LineString {
	...
	protected EClass eStaticClass() {
		return BikePackage.Literals.LINE_STRING;
	}
	...
	public void setCoordinates(LineString_coordinates newCoordinates) {
		if (newCoordinates != coordinates) {
			...
			if (coordinates != null)
				msgs = ((InternalEObject)coordinates).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BikePackage.LINE_STRING__COORDINATES, null, msgs);
			if (newCoordinates != null)
				msgs = ((InternalEObject)newCoordinates).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BikePackage.LINE_STRING__COORDINATES, null, msgs);
			msgs = basicSetCoordinates(newCoordinates, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BikePackage.LINE_STRING__COORDINATES, newCoordinates, newCoordinates));
	}
