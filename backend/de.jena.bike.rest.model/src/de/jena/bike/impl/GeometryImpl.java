 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.bike.impl.GeometryImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GeometryImpl extends MinimalEObjectImpl.Container implements Geometry {
	...
	protected EClass eStaticClass() {
		return BikePackage.Literals.GEOMETRY;
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BikePackage.GEOMETRY__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BikePackage.GEOMETRY__TYPE:
				return getType();
		}
