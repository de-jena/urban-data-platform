...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,de.jena.ilsa.sensinact.model.ilsa\"" })
...
public class IlsaConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(IlsaPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(IlsaPackage.eNS_URI, ePackage);
		}
