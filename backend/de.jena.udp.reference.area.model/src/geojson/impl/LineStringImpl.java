 ...
 * </p>
 * <ul>
 *   <li>{@link geojson.impl.LineStringImpl#getCoordinates <em>Coordinates</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LineStringImpl extends GeometryImpl implements LineString {
	...
	public EList<Double[]> getCoordinates() {
		if (coordinates == null) {
			coordinates = new EDataTypeUniqueEList<Double[]>(Double[].class, this, GeojsonPackage.LINE_STRING__COORDINATES);
		}
		return coordinates;
	}
