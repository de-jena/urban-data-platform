 ...
 * </p>
 * <ul>
 *   <li>{@link geojson.impl.MultiLineStringImpl#getCoordinates <em>Coordinates</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MultiLineStringImpl extends GeometryImpl implements MultiLineString {
	/**
	...
	public EList<Double[][]> getCoordinates() {
		if (coordinates == null) {
			coordinates = new EDataTypeUniqueEList<Double[][]>(Double[][].class, this, GeojsonPackage.MULTI_LINE_STRING__COORDINATES);
		}
		return coordinates;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GeojsonPackage.MULTI_LINE_STRING__COORDINATES:
