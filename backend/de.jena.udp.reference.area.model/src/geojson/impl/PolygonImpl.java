 ...
 * </p>
 * <ul>
 *   <li>{@link geojson.impl.PolygonImpl#getCoordinates <em>Coordinates</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PolygonImpl extends GeometryImpl implements Polygon {
	...
	public EList<Double[][]> getCoordinates() {
		if (coordinates == null) {
			coordinates = new EDataTypeUniqueEList<Double[][]>(Double[][].class, this, GeojsonPackage.POLYGON__COORDINATES);
		}
		return coordinates;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GeojsonPackage.POLYGON__COORDINATES:
