 ...
 * </p>
 * <ul>
 *   <li>{@link geojson.impl.PointImpl#getCoordinates <em>Coordinates</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PointImpl extends GeometryImpl implements Point {
	...
	public EList<Double> getCoordinates() {
		if (coordinates == null) {
			coordinates = new EDataTypeUniqueEList<Double>(Double.class, this, GeojsonPackage.POINT__COORDINATES);
		}
		return coordinates;
	}
