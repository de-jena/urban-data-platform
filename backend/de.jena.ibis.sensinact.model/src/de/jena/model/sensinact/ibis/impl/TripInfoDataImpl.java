...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Trip Info Data</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.TripInfoDataImpl#getDeviceType <em>Device Type</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.TripInfoDataImpl#getLineName <em>Line Name</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.TripInfoDataImpl#getLineNumber <em>Line Number</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.TripInfoDataImpl#getTripNumber <em>Trip Number</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.TripInfoDataImpl#getDeviceNumber <em>Device Number</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.TripInfoDataImpl#isAtStop <em>At Stop</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.TripInfoDataImpl#getStopName <em>Stop Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TripInfoDataImpl extends IbisResourceImpl implements TripInfoData {
	/**
	...
	protected EClass eStaticClass() {
		return IbisSensinactPackage.Literals.TRIP_INFO_DATA;
	}
	...
	public void setDeviceType(String newDeviceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.TRIP_INFO_DATA__DEVICE_TYPE, oldDeviceType, deviceType));
	}
	...
	public void setLineName(String newLineName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.TRIP_INFO_DATA__LINE_NAME, oldLineName, lineName));
	}
	...
	public void setLineNumber(int newLineNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.TRIP_INFO_DATA__LINE_NUMBER, oldLineNumber, lineNumber));
	}
	...
	public void setTripNumber(int newTripNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.TRIP_INFO_DATA__TRIP_NUMBER, oldTripNumber, tripNumber));
	}
	...
	public void setDeviceNumber(int newDeviceNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.TRIP_INFO_DATA__DEVICE_NUMBER, oldDeviceNumber, deviceNumber));
	}
	...
	public void setAtStop(boolean newAtStop) {
		...
		atStop = newAtStop;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.TRIP_INFO_DATA__AT_STOP, oldAtStop, atStop));
	}
	...
	public void setStopName(String newStopName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.TRIP_INFO_DATA__STOP_NAME, oldStopName, stopName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IbisSensinactPackage.TRIP_INFO_DATA__DEVICE_TYPE:
				return getDeviceType();
			case IbisSensinactPackage.TRIP_INFO_DATA__LINE_NAME:
				return getLineName();
			case IbisSensinactPackage.TRIP_INFO_DATA__LINE_NUMBER:
				return getLineNumber();
			case IbisSensinactPackage.TRIP_INFO_DATA__TRIP_NUMBER:
				return getTripNumber();
			case IbisSensinactPackage.TRIP_INFO_DATA__DEVICE_NUMBER:
				return getDeviceNumber();
			case IbisSensinactPackage.TRIP_INFO_DATA__AT_STOP:
				return isAtStop();
			case IbisSensinactPackage.TRIP_INFO_DATA__STOP_NAME:
				return getStopName();
		}
