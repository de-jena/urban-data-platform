...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,de.jena.model.sensinact.ibis\"" })
...
public class IbisSensinactConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(IbisSensinactPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(IbisSensinactPackage.eNS_URI, ePackage);
		}
