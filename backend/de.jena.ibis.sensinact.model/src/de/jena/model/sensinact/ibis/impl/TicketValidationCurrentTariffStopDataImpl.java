 ...
 *   <li>{@link de.jena.model.sensinact.ibis.impl.TicketValidationCurrentTariffStopDataImpl#getStopAlternativeName <em>Stop Alternative Name</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.TicketValidationCurrentTariffStopDataImpl#getPlatform <em>Platform</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.TicketValidationCurrentTariffStopDataImpl#getArrivalScheduled <em>Arrival Scheduled</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.TicketValidationCurrentTariffStopDataImpl#getArrivalExpected <em>Arrival Expected</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.TicketValidationCurrentTariffStopDataImpl#getDepartureScheduled <em>Departure Scheduled</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.TicketValidationCurrentTariffStopDataImpl#getDepartureExpected <em>Departure Expected</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.TicketValidationCurrentTariffStopDataImpl#getRecordedArrivalTime <em>Recorded Arrival Time</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.TicketValidationCurrentTariffStopDataImpl#getDistanceToNextStop <em>Distance To Next Stop</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.TicketValidationCurrentTariffStopDataImpl#getFareZone <em>Fare Zone</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.TicketValidationCurrentTariffStopDataImpl#getCurrentTripRef <em>Current Trip Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TicketValidationCurrentTariffStopDataImpl extends IbisResourceImpl implements TicketValidationCurrentTariffStopData {
	...
	/**
	 * The default value of the '{@link #getCurrentTripRef() <em>Current Trip Ref</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final String CURRENT_TRIP_REF_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getCurrentTripRef() <em>Current Trip Ref</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getCurrentTripRef()
	 * @generated
	 * @ordered
	 */
	protected String currentTripRef = CURRENT_TRIP_REF_EDEFAULT;
	 ...
	 * @generated
	 */
	protected TicketValidationCurrentTariffStopDataImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return IbisSensinactPackage.Literals.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA;
	}
	...
	public void setServiceName(String newServiceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__SERVICE_NAME, oldServiceName, serviceName));
	}
	...
	public void setServiceOperation(String newServiceOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__SERVICE_OPERATION, oldServiceOperation, serviceOperation));
	}
	...
	public void setStopIndex(int newStopIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__STOP_INDEX, oldStopIndex, stopIndex));
	}
	...
	public void setStopRef(String newStopRef) {
		...
		stopRef = newStopRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__STOP_REF, oldStopRef, stopRef));
	}
	...
	public EList<String> getStopName() {
		if (stopName == null) {
			stopName = new EDataTypeUniqueEList<String>(String.class, this, IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__STOP_NAME);
		}
		return stopName;
	}
	...
	public EList<String> getStopAlternativeName() {
		if (stopAlternativeName == null) {
			stopAlternativeName = new EDataTypeUniqueEList<String>(String.class, this, IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__STOP_ALTERNATIVE_NAME);
		}
	...
	public void setPlatform(String newPlatform) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__PLATFORM, oldPlatform, platform));
	}
	...
	public void setArrivalScheduled(Instant newArrivalScheduled) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__ARRIVAL_SCHEDULED, oldArrivalScheduled, arrivalScheduled));
	}
	...
	public void setArrivalExpected(Instant newArrivalExpected) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__ARRIVAL_EXPECTED, oldArrivalExpected, arrivalExpected));
	}
	...
	public void setDepartureScheduled(Instant newDepartureScheduled) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__DEPARTURE_SCHEDULED, oldDepartureScheduled, departureScheduled));
	}
	...
	public void setDepartureExpected(Instant newDepartureExpected) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__DEPARTURE_EXPECTED, oldDepartureExpected, departureExpected));
	}
	...
	public void setRecordedArrivalTime(Instant newRecordedArrivalTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__RECORDED_ARRIVAL_TIME, oldRecordedArrivalTime, recordedArrivalTime));
	}
	...
	public void setDistanceToNextStop(int newDistanceToNextStop) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__DISTANCE_TO_NEXT_STOP, oldDistanceToNextStop, distanceToNextStop));
	}
	...
	public EList<String> getFareZone() {
		if (fareZone == null) {
			fareZone = new EDataTypeUniqueEList<String>(String.class, this, IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__FARE_ZONE);
		}
		return fareZone;
	}
	 ...
	 */
	@Override
	public String getCurrentTripRef() {
	 ...
	 */
	@Override
	public void setCurrentTripRef(String newCurrentTripRef) {
		String oldCurrentTripRef = currentTripRef;
		currentTripRef = newCurrentTripRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__CURRENT_TRIP_REF, oldCurrentTripRef, currentTripRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__SERVICE_NAME:
			...
			case IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__STOP_REF:
				return getStopRef();
			case IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__STOP_NAME:
				return getStopName();
			case IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__STOP_ALTERNATIVE_NAME:
				return getStopAlternativeName();
			case IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__PLATFORM:
				return getPlatform();
			case IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__ARRIVAL_SCHEDULED:
				return getArrivalScheduled();
			case IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__ARRIVAL_EXPECTED:
				return getArrivalExpected();
			case IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__DEPARTURE_SCHEDULED:
				return getDepartureScheduled();
			case IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__DEPARTURE_EXPECTED:
				return getDepartureExpected();
			case IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__RECORDED_ARRIVAL_TIME:
				return getRecordedArrivalTime();
			case IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__DISTANCE_TO_NEXT_STOP:
				return getDistanceToNextStop();
			case IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__FARE_ZONE:
				return getFareZone();
			case IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__CURRENT_TRIP_REF:
				return getCurrentTripRef();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__FARE_ZONE:
				...
				return;
			case IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__CURRENT_TRIP_REF:
				setCurrentTripRef((String)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__FARE_ZONE:
				...
				return;
			case IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__CURRENT_TRIP_REF:
				setCurrentTripRef(CURRENT_TRIP_REF_EDEFAULT);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case IbisSensinactPackage.TICKET_VALIDATION_CURRENT_TARIFF_STOP_DATA__CURRENT_TRIP_REF:
				return CURRENT_TRIP_REF_EDEFAULT == null ? currentTripRef != null : !CURRENT_TRIP_REF_EDEFAULT.equals(currentTripRef);
		}
	...
	public String toString() {
		...
		result.append(fareZone);
		result.append(", currentTripRef: ");
		result.append(currentTripRef);
		result.append(')');
		return result.toString();
	}

} //TicketValidationCurrentTariffStopDataImpl
