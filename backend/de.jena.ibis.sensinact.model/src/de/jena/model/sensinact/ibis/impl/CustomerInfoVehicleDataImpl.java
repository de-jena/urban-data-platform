...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Customer Info Vehicle Data</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 *   <li>{@link de.jena.model.sensinact.ibis.impl.CustomerInfoVehicleDataImpl#isInPanic <em>In Panic</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.CustomerInfoVehicleDataImpl#isVehicleStopRequested <em>Vehicle Stop Requested</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.CustomerInfoVehicleDataImpl#getExitSide <em>Exit Side</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.CustomerInfoVehicleDataImpl#isMovingDirectionForward <em>Moving Direction Forward</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.CustomerInfoVehicleDataImpl#getVehicleMode <em>Vehicle Mode</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.CustomerInfoVehicleDataImpl#isSpeakerActive <em>Speaker Active</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.CustomerInfoVehicleDataImpl#isStopInformationActive <em>Stop Information Active</em>}</li>
 *   <li>{@link de.jena.model.sensinact.ibis.impl.CustomerInfoVehicleDataImpl#getTripState <em>Trip State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CustomerInfoVehicleDataImpl extends IbisResourceImpl implements CustomerInfoVehicleData {
	 ...
	 * @generated
	 */
	protected CustomerInfoVehicleDataImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return IbisSensinactPackage.Literals.CUSTOMER_INFO_VEHICLE_DATA;
	}
	...
	public void setServiceName(String newServiceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__SERVICE_NAME, oldServiceName, serviceName));
	}
	...
	public void setServiceOperation(String newServiceOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__SERVICE_OPERATION, oldServiceOperation, serviceOperation));
	}
	...
	public void setVehicleRef(String newVehicleRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__VEHICLE_REF, oldVehicleRef, vehicleRef));
	}
	...
	public void setRouteDeviation(String newRouteDeviation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__ROUTE_DEVIATION, oldRouteDeviation, routeDeviation));
	}
	...
	public void setDoorState(String newDoorState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__DOOR_STATE, oldDoorState, doorState));
	}
	...
	public void setInPanic(boolean newInPanic) {
		...
		inPanic = newInPanic;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__IN_PANIC, oldInPanic, inPanic));
	}
	...
	public void setVehicleStopRequested(boolean newVehicleStopRequested) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__VEHICLE_STOP_REQUESTED, oldVehicleStopRequested, vehicleStopRequested));
	}
	...
	public void setExitSide(String newExitSide) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__EXIT_SIDE, oldExitSide, exitSide));
	}
	...
	public void setMovingDirectionForward(boolean newMovingDirectionForward) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__MOVING_DIRECTION_FORWARD, oldMovingDirectionForward, movingDirectionForward));
	}
	...
	public void setVehicleMode(String newVehicleMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__VEHICLE_MODE, oldVehicleMode, vehicleMode));
	}
	...
	public void setSpeakerActive(boolean newSpeakerActive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__SPEAKER_ACTIVE, oldSpeakerActive, speakerActive));
	}
	...
	public void setStopInformationActive(boolean newStopInformationActive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__STOP_INFORMATION_ACTIVE, oldStopInformationActive, stopInformationActive));
	}
	...
	public void setTripState(String newTripState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__TRIP_STATE, oldTripState, tripState));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__SERVICE_NAME:
			...
			case IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__DOOR_STATE:
				return getDoorState();
			case IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__IN_PANIC:
				return isInPanic();
			case IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__VEHICLE_STOP_REQUESTED:
				return isVehicleStopRequested();
			case IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__EXIT_SIDE:
				return getExitSide();
			case IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__MOVING_DIRECTION_FORWARD:
				return isMovingDirectionForward();
			case IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__VEHICLE_MODE:
				return getVehicleMode();
			case IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__SPEAKER_ACTIVE:
				return isSpeakerActive();
			case IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__STOP_INFORMATION_ACTIVE:
				return isStopInformationActive();
			case IbisSensinactPackage.CUSTOMER_INFO_VEHICLE_DATA__TRIP_STATE:
				return getTripState();
		}
