...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,de.jena.sensinact.rest.tlc.control.model.control\"" })
...
public class TlcControlConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(TlcControlPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(TlcControlPackage.eNS_URI, ePackage);
		}
