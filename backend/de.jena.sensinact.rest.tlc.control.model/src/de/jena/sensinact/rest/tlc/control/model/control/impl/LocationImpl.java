 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.sensinact.rest.tlc.control.model.control.impl.LocationImpl#getLatitude <em>Latitude</em>}</li>
 *   <li>{@link de.jena.sensinact.rest.tlc.control.model.control.impl.LocationImpl#getLongitude <em>Longitude</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LocationImpl extends MinimalEObjectImpl.Container implements Location {
	...
	protected EClass eStaticClass() {
		return TlcControlPackage.eINSTANCE.getLocation();
	}
	...
	public void setLatitude(String newLatitude) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TlcControlPackage.LOCATION__LATITUDE, oldLatitude, latitude));
	}
	...
	public void setLongitude(String newLongitude) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TlcControlPackage.LOCATION__LONGITUDE, oldLongitude, longitude));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TlcControlPackage.LOCATION__LATITUDE:
				return getLatitude();
			case TlcControlPackage.LOCATION__LONGITUDE:
				return getLongitude();
		}
