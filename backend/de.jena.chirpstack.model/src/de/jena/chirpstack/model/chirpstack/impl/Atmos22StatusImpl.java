...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Atmos22 Status</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.Atmos22StatusImpl#getBattery <em>Battery</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Atmos22StatusImpl extends ServiceImpl implements Atmos22Status {
	/**
	...
	protected EClass eStaticClass() {
		return ChirpstackPackage.Literals.ATMOS22_STATUS;
	}
	...
	public void setBattery(double newBattery) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.ATMOS22_STATUS__BATTERY, oldBattery, battery));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ChirpstackPackage.ATMOS22_STATUS__BATTERY:
				return getBattery();
		}
