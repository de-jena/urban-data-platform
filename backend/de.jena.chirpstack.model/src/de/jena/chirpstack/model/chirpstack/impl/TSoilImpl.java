 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.TSoilImpl#getSoilWaterTension1 <em>Soil Water Tension1</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.TSoilImpl#getSoilWaterTension2 <em>Soil Water Tension2</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.TSoilImpl#getSoilMoistureRaw1 <em>Soil Moisture Raw1</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.TSoilImpl#getSoilMoistureRaw2 <em>Soil Moisture Raw2</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.TSoilImpl#getAmbientLight <em>Ambient Light</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TSoilImpl extends ServiceImpl implements TSoil {
	...
	protected EClass eStaticClass() {
		return ChirpstackPackage.Literals.TSOIL;
	}
	...
	public void setSoilWaterTension1(double newSoilWaterTension1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.TSOIL__SOIL_WATER_TENSION1, oldSoilWaterTension1, soilWaterTension1));
	}
	...
	public void setSoilWaterTension2(double newSoilWaterTension2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.TSOIL__SOIL_WATER_TENSION2, oldSoilWaterTension2, soilWaterTension2));
	}
	...
	public void setSoilMoistureRaw1(double newSoilMoistureRaw1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.TSOIL__SOIL_MOISTURE_RAW1, oldSoilMoistureRaw1, soilMoistureRaw1));
	}
	...
	public void setSoilMoistureRaw2(double newSoilMoistureRaw2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.TSOIL__SOIL_MOISTURE_RAW2, oldSoilMoistureRaw2, soilMoistureRaw2));
	}
	...
	public void setAmbientLight(double newAmbientLight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.TSOIL__AMBIENT_LIGHT, oldAmbientLight, ambientLight));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ChirpstackPackage.TSOIL__SOIL_WATER_TENSION1:
				return getSoilWaterTension1();
			case ChirpstackPackage.TSOIL__SOIL_WATER_TENSION2:
				return getSoilWaterTension2();
			case ChirpstackPackage.TSOIL__SOIL_MOISTURE_RAW1:
				return getSoilMoistureRaw1();
			case ChirpstackPackage.TSOIL__SOIL_MOISTURE_RAW2:
				return getSoilMoistureRaw2();
			case ChirpstackPackage.TSOIL__AMBIENT_LIGHT:
