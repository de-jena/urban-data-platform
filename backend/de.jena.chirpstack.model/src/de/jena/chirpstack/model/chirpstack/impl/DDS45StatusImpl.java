...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>DDS45 Status</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.DDS45StatusImpl#getBattery <em>Battery</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DDS45StatusImpl extends ServiceImpl implements DDS45Status {
	/**
	...
	protected EClass eStaticClass() {
		return ChirpstackPackage.Literals.DDS45_STATUS;
	}
	...
	public void setBattery(double newBattery) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.DDS45_STATUS__BATTERY, oldBattery, battery));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ChirpstackPackage.DDS45_STATUS__BATTERY:
				return getBattery();
		}
