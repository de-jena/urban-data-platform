 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.DeviceImpl#getDevEUI <em>Dev EUI</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.DeviceImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.DeviceImpl#getProfileId <em>Profile Id</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.DeviceImpl#getProfileName <em>Profile Name</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.DeviceImpl#getTenantId <em>Tenant Id</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.DeviceImpl#getTenantName <em>Tenant Name</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.DeviceImpl#getApplicationId <em>Application Id</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.DeviceImpl#getApplicationName <em>Application Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeviceImpl extends ServiceImpl implements Device {
	...
	protected EClass eStaticClass() {
		return ChirpstackPackage.Literals.DEVICE;
	}
	...
	public void setDevEUI(String newDevEUI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.DEVICE__DEV_EUI, oldDevEUI, devEUI));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.DEVICE__NAME, oldName, name));
	}
	...
	public void setProfileId(String newProfileId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.DEVICE__PROFILE_ID, oldProfileId, profileId));
	}
	...
	public void setProfileName(String newProfileName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.DEVICE__PROFILE_NAME, oldProfileName, profileName));
	}
	...
	public void setTenantId(String newTenantId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.DEVICE__TENANT_ID, oldTenantId, tenantId));
	}
	...
	public void setTenantName(String newTenantName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.DEVICE__TENANT_NAME, oldTenantName, tenantName));
	}
	...
	public void setApplicationId(String newApplicationId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.DEVICE__APPLICATION_ID, oldApplicationId, applicationId));
	}
	...
	public void setApplicationName(String newApplicationName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.DEVICE__APPLICATION_NAME, oldApplicationName, applicationName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ChirpstackPackage.DEVICE__DEV_EUI:
				return getDevEUI();
			case ChirpstackPackage.DEVICE__NAME:
				return getName();
			case ChirpstackPackage.DEVICE__PROFILE_ID:
				return getProfileId();
			case ChirpstackPackage.DEVICE__PROFILE_NAME:
				return getProfileName();
			case ChirpstackPackage.DEVICE__TENANT_ID:
				return getTenantId();
			case ChirpstackPackage.DEVICE__TENANT_NAME:
				return getTenantName();
			case ChirpstackPackage.DEVICE__APPLICATION_ID:
				return getApplicationId();
			case ChirpstackPackage.DEVICE__APPLICATION_NAME:
