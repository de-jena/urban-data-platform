...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Atmos Status</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.AtmosStatusImpl#getBattery <em>Battery</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AtmosStatusImpl extends ServiceImpl implements AtmosStatus {
	/**
	...
	protected EClass eStaticClass() {
		return ChirpstackPackage.Literals.ATMOS_STATUS;
	}
	...
	public void setBattery(double newBattery) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.ATMOS_STATUS__BATTERY, oldBattery, battery));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ChirpstackPackage.ATMOS_STATUS__BATTERY:
				return getBattery();
		}
