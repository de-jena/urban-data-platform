 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.SoilImpl#getTemperature <em>Temperature</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.SoilImpl#getWater <em>Water</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.SoilImpl#getConduct <em>Conduct</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SoilImpl extends ServiceImpl implements Soil {
	...
	protected EClass eStaticClass() {
		return ChirpstackPackage.Literals.SOIL;
	}
	...
	public void setTemperature(double newTemperature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.SOIL__TEMPERATURE, oldTemperature, temperature));
	}
	...
	public void setWater(double newWater) {
		...
		water = newWater;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.SOIL__WATER, oldWater, water));
	}
	...
	public void setConduct(double newConduct) {
		...
		conduct = newConduct;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.SOIL__CONDUCT, oldConduct, conduct));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ChirpstackPackage.SOIL__TEMPERATURE:
				return getTemperature();
			case ChirpstackPackage.SOIL__WATER:
				return getWater();
			case ChirpstackPackage.SOIL__CONDUCT:
				return getConduct();
		}
