 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.SensorImpl#getBattery <em>Battery</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.SensorImpl#getIflag <em>Iflag</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.SensorImpl#getSflag <em>Sflag</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.SensorImpl#getMod <em>Mod</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.SensorImpl#getTemperatureDS18B20 <em>Temperature DS18B20</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SensorImpl extends ServiceImpl implements Sensor {
	...
	protected EClass eStaticClass() {
		return ChirpstackPackage.Literals.SENSOR;
	}
	...
	public void setBattery(double newBattery) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.SENSOR__BATTERY, oldBattery, battery));
	}
	...
	public void setIflag(double newIflag) {
		...
		iflag = newIflag;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.SENSOR__IFLAG, oldIflag, iflag));
	}
	...
	public void setSflag(double newSflag) {
		...
		sflag = newSflag;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.SENSOR__SFLAG, oldSflag, sflag));
	}
	...
	public void setMod(double newMod) {
		...
		mod = newMod;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.SENSOR__MOD, oldMod, mod));
	}
	...
	public void setTemperatureDS18B20(float newTemperatureDS18B20) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.SENSOR__TEMPERATURE_DS18B20, oldTemperatureDS18B20, temperatureDS18B20));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ChirpstackPackage.SENSOR__BATTERY:
				return getBattery();
			case ChirpstackPackage.SENSOR__IFLAG:
				return getIflag();
			case ChirpstackPackage.SENSOR__SFLAG:
				return getSflag();
			case ChirpstackPackage.SENSOR__MOD:
				return getMod();
			case ChirpstackPackage.SENSOR__TEMPERATURE_DS18B20:
