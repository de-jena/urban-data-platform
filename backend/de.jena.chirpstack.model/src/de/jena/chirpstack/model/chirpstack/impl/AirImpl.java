 ...
 * </p>
 * <ul>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.AirImpl#getAirTemperature <em>Air Temperature</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.AirImpl#getAirHumidity <em>Air Humidity</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.AirImpl#getBarometricPressure <em>Barometric Pressure</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.AirImpl#getPeakWindGust <em>Peak Wind Gust</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.AirImpl#getWindSpeed <em>Wind Speed</em>}</li>
 *   <li>{@link de.jena.chirpstack.model.chirpstack.impl.AirImpl#getWindDirectionSensor <em>Wind Direction Sensor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AirImpl extends ServiceImpl implements Air {
	...
	protected EClass eStaticClass() {
		return ChirpstackPackage.Literals.AIR;
	}
	...
	public void setAirTemperature(double newAirTemperature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.AIR__AIR_TEMPERATURE, oldAirTemperature, airTemperature));
	}
	...
	public void setAirHumidity(double newAirHumidity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.AIR__AIR_HUMIDITY, oldAirHumidity, airHumidity));
	}
	...
	public void setBarometricPressure(double newBarometricPressure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.AIR__BAROMETRIC_PRESSURE, oldBarometricPressure, barometricPressure));
	}
	...
	public void setPeakWindGust(double newPeakWindGust) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.AIR__PEAK_WIND_GUST, oldPeakWindGust, peakWindGust));
	}
	...
	public void setWindSpeed(double newWindSpeed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.AIR__WIND_SPEED, oldWindSpeed, windSpeed));
	}
	...
	public void setWindDirectionSensor(double newWindDirectionSensor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ChirpstackPackage.AIR__WIND_DIRECTION_SENSOR, oldWindDirectionSensor, windDirectionSensor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ChirpstackPackage.AIR__AIR_TEMPERATURE:
				return getAirTemperature();
			case ChirpstackPackage.AIR__AIR_HUMIDITY:
				return getAirHumidity();
			case ChirpstackPackage.AIR__BAROMETRIC_PRESSURE:
				return getBarometricPressure();
			case ChirpstackPackage.AIR__PEAK_WIND_GUST:
				return getPeakWindGust();
			case ChirpstackPackage.AIR__WIND_SPEED:
				return getWindSpeed();
			case ChirpstackPackage.AIR__WIND_DIRECTION_SENSOR:
