...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,de.dim.trafficos.model.device\"" })
...
public class TOSDeviceConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(TOSDevicePackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(TOSDevicePackage.eNS_URI, ePackage);
		}
