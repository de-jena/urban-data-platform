 ...
 * </p>
 * <ul>
 *   <li>{@link de.dim.trafficos.model.device.impl.ParameterImpl#getDataType <em>Data Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterImpl extends IdNameElementImpl implements Parameter {
	...
	protected EClass eStaticClass() {
		return TOSDevicePackage.Literals.PARAMETER;
	}
	...
	public void setDataType(ParameterDataType newDataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TOSDevicePackage.PARAMETER__DATA_TYPE, oldDataType, dataType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TOSDevicePackage.PARAMETER__DATA_TYPE:
				return getDataType();
		}
