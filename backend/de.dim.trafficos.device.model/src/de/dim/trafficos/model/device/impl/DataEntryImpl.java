 ...
 * </p>
 * <ul>
 *   <li>{@link de.dim.trafficos.model.device.impl.DataEntryImpl#getValue <em>Value</em>}</li>
 *   <li>{@link de.dim.trafficos.model.device.impl.DataEntryImpl#getConfiguration <em>Configuration</em>}</li>
 *   <li>{@link de.dim.trafficos.model.device.impl.DataEntryImpl#getDevice <em>Device</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataEntryImpl extends AbstractDataEntryImpl implements DataEntry {
	...
	public EList<DataValue> getValue() {
		if (value == null) {
			value = new EObjectContainmentEList<DataValue>(DataValue.class, this, TOSDevicePackage.DATA_ENTRY__VALUE);
		}
		return value;
	}
	...
	public void setConfiguration(String newConfiguration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TOSDevicePackage.DATA_ENTRY__CONFIGURATION, oldConfiguration, configuration));
	}
	...
	public void setDevice(String newDevice) {
		...
		device = newDevice;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TOSDevicePackage.DATA_ENTRY__DEVICE, oldDevice, device));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TOSDevicePackage.DATA_ENTRY__VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TOSDevicePackage.DATA_ENTRY__VALUE:
				return getValue();
			case TOSDevicePackage.DATA_ENTRY__CONFIGURATION:
				return getConfiguration();
			case TOSDevicePackage.DATA_ENTRY__DEVICE:
				return getDevice();
		}
