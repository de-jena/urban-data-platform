 ...
 * </p>
 * <ul>
 *   <li>{@link de.dim.trafficos.model.device.impl.ProgramTransitionImpl#getTransition <em>Transition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProgramTransitionImpl extends ProgramEntryImpl implements ProgramTransition {
		...
		if (transition != null && transition.eIsProxy()) {
			...
			if (transition != oldTransition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TOSDevicePackage.PROGRAM_TRANSITION__TRANSITION, oldTransition, transition));
			}
		}
		return transition;
	}
	...
	public void setTransition(Transition newTransition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TOSDevicePackage.PROGRAM_TRANSITION__TRANSITION, oldTransition, transition));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TOSDevicePackage.PROGRAM_TRANSITION__TRANSITION:
