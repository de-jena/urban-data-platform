...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,de.jena.conflict.sensinact.model.conflictProvider\"" })
...
public class ConflictConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(ConflictPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(ConflictPackage.eNS_URI, ePackage);
		}
