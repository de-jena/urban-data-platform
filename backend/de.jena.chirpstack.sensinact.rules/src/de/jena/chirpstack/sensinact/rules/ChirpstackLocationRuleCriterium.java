 ...
 * @since Nov 24, 2025
 */
public class ChirpstackLocationRuleCriterium implements ICriterion{
	...
	public Predicate<ServiceSnapshot> getServiceFilter() {
		return snapshot -> {
			return snapshot.getName().equals("admin") || snapshot.getName().equals("sensor"); 
		};
	}
	...
	public Predicate<ResourceSnapshot> getResourceFilter() {
		return snapshot -> {
			return snapshot.getName().equals("location") || snapshot.getName().equals("potentialWater1");
		};
	}
