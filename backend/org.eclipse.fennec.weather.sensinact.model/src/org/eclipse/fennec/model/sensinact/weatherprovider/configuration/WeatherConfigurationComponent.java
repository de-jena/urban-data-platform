 ...
 */
package org.eclipse.fennec.model.sensinact.weatherprovider.configuration;
...
import org.eclipse.fennec.model.sensinact.weatherprovider.impl.WeatherPackageImpl;

import org.eclipse.fennec.model.sensinact.weatherprovider.util.WeatherResourceFactoryImpl;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.model.sensinact.weatherprovider.util.WeatherResourceFactoryImpl, org.eclipse.emf.ecore.resource.Resource$Factory\"" , "uses:=\"org.eclipse.emf.ecore.resource,org.eclipse.fennec.model.sensinact.weatherprovider.util\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.model.sensinact.weatherprovider.WeatherFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.model.sensinact.weatherprovider\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.model.sensinact.weatherprovider.WeatherPackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.model.sensinact.weatherprovider\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.fennec.model.sensinact.weatherprovider\"" })
