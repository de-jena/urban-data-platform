...
public class WeatherSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case WeatherPackage.WEATHER_SERVICE: {
				WeatherService weatherService = (WeatherService)theEObject;
				T result = caseWeatherService(weatherService);
				if (result == null) result = caseService(weatherService);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseWeatherService(WeatherService object) {
		return null;
	}
