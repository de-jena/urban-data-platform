...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,de.jena.chirpstack.model.dummymoisture\"" })
...
public class DummyMoistureConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(DummyMoisturePackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(DummyMoisturePackage.eNS_URI, ePackage);
		}
