 ...
 * @generated
 */
public class DummyMoistureSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DummyMoisturePackage.MOISTURE_SENSOR: {
			...
			case DummyMoisturePackage.MOISTURE_STATUS: {
			...
			case DummyMoisturePackage.MOISTURE_ADMIN: {
