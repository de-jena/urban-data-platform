...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"geojson.util.GeojsonResourceFactoryImpl, org.eclipse.emf.ecore.resource.Resource$Factory\"" , "uses:=\"org.eclipse.emf.ecore.resource,geojson.util\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"geojson.GeojsonFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=\"org.eclipse.emf.ecore,geojson\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"geojson.GeojsonPackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=\"org.eclipse.emf.ecore,geojson\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,geojson\"" })
