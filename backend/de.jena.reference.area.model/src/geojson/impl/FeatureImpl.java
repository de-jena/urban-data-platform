 ...
 * </p>
 * <ul>
 *   <li>{@link geojson.impl.FeatureImpl#getType <em>Type</em>}</li>
 *   <li>{@link geojson.impl.FeatureImpl#getGeometry <em>Geometry</em>}</li>
 *   <li>{@link geojson.impl.FeatureImpl#getProperties <em>Properties</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeatureImpl extends GeoJSONImpl implements Feature {
	...
	public EMap<String, String> getProperties() {
		if (properties == null) {
			properties = new EcoreEMap<String,String>(GeojsonPackage.Literals.STRING_TO_STRING_MAP, StringToStringMapImpl.class, this, GeojsonPackage.FEATURE__PROPERTIES);
		}
		return properties;
	}
