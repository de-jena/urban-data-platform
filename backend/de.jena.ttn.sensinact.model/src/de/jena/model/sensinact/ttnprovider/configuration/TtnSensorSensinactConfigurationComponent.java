...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,de.jena.model.sensinact.ttnprovider\"" })
...
public class TtnSensorSensinactConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(TtnSensorSensinactPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(TtnSensorSensinactPackage.eNS_URI, ePackage);
		}
